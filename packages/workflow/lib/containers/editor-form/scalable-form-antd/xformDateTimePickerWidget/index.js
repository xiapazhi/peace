...
})("461a2a890d303dc7e03ab23486fabdf1", ".xform-custom-datetimepicker .ant-calendar-picker{width:100%!important}");
...
var CustomDateTimePickerWidget = /*#__PURE__*/function (_Component) {
  ...
  function CustomDateTimePickerWidget() {
  ...
  _createClass(CustomDateTimePickerWidget, [{
    ...
    value: function render() {
      ...
      var format = schema.format || 'date-time';
      ...
      switch (format) {
        case 'date-time':
          if (typeof value !== 'undefined' && value !== '') {
            form = /*#__PURE__*/_react["default"].createElement(_antd.DatePicker, _extends({
              showTime: true,
