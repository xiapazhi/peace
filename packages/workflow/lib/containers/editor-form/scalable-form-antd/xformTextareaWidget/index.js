...
var CustomTextareaWidget = /*#__PURE__*/function (_Component) {
  _inherits(CustomTextareaWidget, _Component);
  ...
  _createClass(CustomTextareaWidget, [{
    ...
    value: function render() {
      ...
      var maxLength = schema.maxLength,
          minLength = schema.minLength; //解析schema中约定的_errorType字段，用来标识是validate中哪种类型校验不通过
      ...
      }, /*#__PURE__*/_react["default"].createElement(_$components.LimitTextArea, _extends({
