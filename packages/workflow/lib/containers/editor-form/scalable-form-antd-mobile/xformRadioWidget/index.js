...
})("5c11e4196732e3ce296ccccf6dba23ef", ".xform-custom-radio-button.disabled .am-list-content,.xform-custom-radio-button.disabled .am-list-extra,.xform-custom-radio.disabled .am-list-content,.xform-custom-radio.disabled .am-list-extra{color:#bbb}");

var RadioItem = _antdMobile.Radio.RadioItem;
var ListItem = _antdMobile.List.Item;

var CustomRadio = /*#__PURE__*/function (_PureComponent) {
  _inherits(CustomRadio, _PureComponent);
  ...
  _createClass(CustomRadio, [{
    ...
    value: function render() {
      ...
      if (typeof schema.data !== 'undefined' && schema.data.length >= 0) {
        schema.data.map(function (schemaItem) {
      ...
      if (enums.length <= 2) {
        return /*#__PURE__*/_react["default"].createElement("div", {
          ...
          wrap: true,
          multipleLine: true,
          extra: /*#__PURE__*/_react["default"].createElement(_antdMobile.SegmentedControl, _extends({
            tintColor: "#3296FA",
            values: enumNames,
            ...
            onChange: function onChange(event) {
              if (typeof event.nativeEvent !== 'undefined') {
                _onChange(enums[event.nativeEvent.selectedSegmentIndex]);
              } else {
                _onChange(enums[event.selectedSegmentIndex]);
              }
            }
          }, options))
        ...
        }, label)), enumOptions.map(function (enums) {
