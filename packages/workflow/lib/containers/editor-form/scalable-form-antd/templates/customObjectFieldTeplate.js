  ...
  _createClass(CustomObjectFieldTemplate, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          schema = _this$props$formConte.schema;
      ...
      var curWidgetId = idSchema['$id'].split('_')[1];
      var isTableGroup = uiSchema && (uiSchema['ui:widget'] && uiSchema['ui:widget'] == 'Table' || uiSchema[curWidgetId] && uiSchema[curWidgetId]['items'] && uiSchema[curWidgetId]['items']['ui:widget'] == 'Table');
      var isTableArray = isTableGroup && schema.properties[curWidgetId] && schema.properties[curWidgetId].type == 'array';
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        return /*#__PURE__*/_react["default"].createElement("div", {
          style: Object.assign({}, style, isTableGroup ? {
