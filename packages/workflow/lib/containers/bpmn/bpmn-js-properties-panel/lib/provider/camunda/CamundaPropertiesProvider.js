...
function createGeneralTabGroups(element, canvas, bpmnFactory, elementRegistry, elementTemplates, translate) {
  ...
  processProps(generalGroup, element, translate, processOptions); //versionTag(generalGroup, element, translate);
  ...
  multiInstanceProps(multiInstanceGroup, element, bpmnFactory, translate); // var asyncGroup = {
  //   id : 'async',
  ...
  tasklist(tasklistGroup, element, bpmnFactory, translate); // var documentationGroup = {
  //   id: 'documentation',
  ...
  groups.push(detailsGroup); //groups.push(externalTaskGroup);

  groups.push(multiInstanceGroup); //groups.push(asyncGroup);
  //groups.push(jobConfigurationGroup);
  //groups.push(candidateStarterGroup);
  //groups.push(historyTimeToLiveGroup);

  groups.push(tasklistGroup); //groups.push(documentationGroup);
  // groups.push(userTaskdetailsGroup);
...
function CamundaPropertiesProvider(eventBus, canvas, bpmnFactory, elementRegistry, elementTemplates, translate) {
  ...
  this.getTabs = function (element) {
    ...
    return [generalTab, //variablesTab,
    //connectorTab,
    formsTab //listenersTab,
    //inputOutputTab,
    //fieldInjectionsTab,
    //extensionsTab
    ];
...
CamundaPropertiesProvider.$inject = ['eventBus', 'canvas', 'bpmnFactory', 'elementRegistry', 'elementTemplates', 'translate'];
