  ...
  _createClass(CustomArrayFieldTemplate, [{
    ...
    value: function render() {
      ...
      var uiSchema = props.uiSchema,
          ...
          schema = props.schema;
      var options = uiSchema.items && uiSchema.items['ui:options'] || {};
      var isTableArray = uiSchema.items && uiSchema.items['ui:widget'] == 'Table' && schema.type == 'array'; //const hiddenClassName = uiSchema.items && uiSchema.items.classNames || '';
      //判断节点是否禁用 禁用不可增加
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        return /*#__PURE__*/_react["default"].createElement("div", {
          ...
          style: Object.assign({}, isTableArray ? {
