...
})("a4aad29aac4f801adf22cffbcdc897af", ".xform-custom-slider-range .xform-slider-range-wrapper{padding:12.5px 15px;background:#fff}.xform-custom-slider-range.disabled .am-list-content,.xform-custom-slider-range.disabled .am-list-extra{color:#bbb}");
  ...
  _createClass(CustomSliderRange, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: "xform-slider-range-wrapper"
      }, /*#__PURE__*/_react["default"].createElement(_antdMobile.Range, _extends({
        id: id,
        disabled: disabled,
        readOnly: readonly,
        value: value,
