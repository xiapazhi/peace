...
})("692a1cbfeb13e1650bc73d33d315288d", ".xform-custom-boolean-checkbox{line-height:32px}");

var CustomBooleanCheckbox = /*#__PURE__*/function (_Component) {
  _inherits(CustomBooleanCheckbox, _Component);
  ...
  _createClass(CustomBooleanCheckbox, [{
    ...
    value: function render() {
      var label = this.props.label,
          ...
          value = this.props.value; //判断节点禁用属性
