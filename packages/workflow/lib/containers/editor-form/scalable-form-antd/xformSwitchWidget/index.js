...
var CustomSwitch = /*#__PURE__*/function (_PureComponent) {
  _inherits(CustomSwitch, _PureComponent);

  var _super = _createSuper(CustomSwitch);
  ...
  function CustomSwitch(props) {
    ...
    _this.handleSwitchChange = _this.handleSwitchChange.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(CustomSwitch, [{
    ...
    value: function handleSwitchChange(checked) {
    ...
    value: function render() {
      ...
      otherOptions = this._filterSystemOptions(otherOptions); //判断节点禁用属性
