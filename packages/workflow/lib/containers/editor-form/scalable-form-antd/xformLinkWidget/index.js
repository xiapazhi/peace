...
var CustomLinkWidget = /*#__PURE__*/function (_Component) {
  _inherits(CustomLinkWidget, _Component);

  var _super = _createSuper(CustomLinkWidget);

  function CustomLinkWidget() {
    _classCallCheck(this, CustomLinkWidget);

    return _super.apply(this, arguments);
  }

  _createClass(CustomLinkWidget, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var logger = this.props.formContext.logger;
      logger.logEvent('widget', 'show', 'link');
    }
  }, {
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          options = _this$props.options; //解析schema中约定的_errorType字段，用来标识是validate中哪种类型校验不通过
      ...
      }, /*#__PURE__*/_react["default"].createElement("a", _extends({}, otherOptions, {
        target: "_blank",
        href: value
      }), '点击查看'), /*#__PURE__*/_react["default"].createElement("div", {
...
exports["default"] = CustomLinkWidget;