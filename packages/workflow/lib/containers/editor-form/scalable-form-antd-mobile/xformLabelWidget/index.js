...
})("1963dc36fca2470e7453d321d4d664b2", ".xform-custom-label.disabled .am-list-content,.xform-custom-label.disabled .am-list-extra{color:#bbb}");

var ListItem = _antdMobile.List.Item;

var CustomLabelWidget = /*#__PURE__*/function (_PureComponent) {
  _inherits(CustomLabelWidget, _PureComponent);
  ...
  _createClass(CustomLabelWidget, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          disabled = _this$props.disabled; //解析schema中约定的_errorType字段，用来标识是validate中哪种类型校验不通过
      ...
      }, /*#__PURE__*/_react["default"].createElement(ListItem, _extends({
        wrap: true,
        multipleLine: true,
        extra: value
      }, otherOptions), label), /*#__PURE__*/_react["default"].createElement("div", {
