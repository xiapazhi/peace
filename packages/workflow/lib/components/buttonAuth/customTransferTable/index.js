...
var CustomTransferTable = /*#__PURE__*/function (_Component) {
  _inherits(CustomTransferTable, _Component);

  var _super = _createSuper(CustomTransferTable);

  function CustomTransferTable(props) {
    var _this;

    _classCallCheck(this, CustomTransferTable);
  ...
  _createClass(CustomTransferTable, [{
    key: "componentDidMount",
    value: function componentDidMount() {// const logger = this.props.formContext.logger;
    ...
    value: function render() {
      ...
      var data = this.props.transferData,
  ...
  return CustomTransferTable;
}(_react.Component);

exports["default"] = CustomTransferTable;