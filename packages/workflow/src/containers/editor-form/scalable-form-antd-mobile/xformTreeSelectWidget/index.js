...
export default class CustomTreeSelect extends Component {
    ...
    setTreeDataParent(data, parent) {
        return data.map(e => {
            if (e.children && e.children.length > 0) {
                return {
                    ...e,
                    parent,
                    children: this.setTreeDataParent(e.children, e.value)
                }
            } else {
                return {
                    ...e,
    ...
    render() {
        ...
        let data = schema.treeSelectData || [];
        ...
        //节点添加父节点值
        data = this.setTreeDataParent(data, utils.getTreeRootValue());
        // 构造treeData
        let treeData = {
