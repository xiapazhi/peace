...
})("c194605241501de0671d832032a47989", ".xform-custom-number-input.disabled .am-list-content,.xform-custom-number-input.disabled .am-list-extra{color:#bbb}");

var ListItem = _antdMobile.List.Item;

var CustomNumberWidget = /*#__PURE__*/function (_PureComponent) {
  _inherits(CustomNumberWidget, _PureComponent);
  ...
  _createClass(CustomNumberWidget, [{
    ...
    value: function _filterSystemOptions(options) {
      var BLACK_LIST = ['enumOptions', 'disabled', 'readonly'];
    ...
    value: function render() {
      ...
      var max = typeof schema.maximum !== 'undefined' ? schema.maximum : Infinity;
      var min = typeof schema.minimum !== 'undefined' ? schema.minimum : -Infinity;
      var step = typeof schema.multipleOf !== 'undefined' ? schema.multipleOf : 1; //解析schema中约定的_errorType字段，用来标识是validate中哪种类型校验不通过
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        wrap: true,
        multipleLine: true,
        extra: /*#__PURE__*/_react["default"].createElement(_antdMobile.Stepper, _extends({
          style: {
            width: '100%',
            minWidth: '100px'
          },
