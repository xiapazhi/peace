...
module.exports = function (group, element, bpmnFactory, translate) {
  ...
  group.entries.push(entryFactory.textField({
    ...
    validate: function (element, values, node) {
      ...
      if (mapping) {
        if (!values.source) {
          validation.source = validation.source = values.sourceLabel ? translate('Mapping must have a {value}', {
        ...
        if (WHITESPACE_REGEX.test(values.source) && inOutType !== 'sourceExpression') {
          validation.source = translate('{label} must not contain whitespace', {
