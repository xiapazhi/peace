...
const CustomInfoWindow = (props) => {
    ...
    return (
        <div style={{ width: '100%' }}>
            <Row className="sensorDataTitle" style={{ fontSize: 16, marginTop: 10, marginBottom: 8 }}>
            ...
            <Row className="sensorData" style={{ marginTop: 10 }}>
                {
                    factors?.length <= 6 ?
                        factors.map((sd, index) => {
                            return (
                                <Col span={7} className='sensorDataCol' key={index}>
            ...
            <Row className="realTimeMonitoringStatusTitle" style={{ marginTop: 18 }}>
                <Col span={8} style={{ marginLeft: 20 }}>
