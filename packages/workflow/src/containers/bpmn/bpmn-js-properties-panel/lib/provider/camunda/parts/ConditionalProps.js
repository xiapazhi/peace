...
module.exports = function(group, element, bpmnFactory, translate) {
  ...
  group.entries.push({
    ...
    html: '<div class="bpp-row bpp-hide">' +
              ...
              '<div class="bpp-field-wrapper">' +
                '<select id="cam-condition-type" name="conditionType" data-value>' +
                  //'<option value="pass">'+ escapeHTML(translate('同意')) + '</option>' +
            ...
            '<div class="bpp-row bpp-hide">' +
              ...
              '</div>' +
              '<div data-show="isScript" class="bpp-hide">' +
                script.template +
              '</div>' +
            '</div>' + 
            '<div class="bpp-row">' +
              '<label for="cam-multiInstance-type">'+ escapeHTML('流转条件配置') + '</label>' +
              '<div class="bpp-field-wrapper">' +
                '<input type="button" class="btn-select"  value="编辑" onclick="openBpmnModal(\'conditionExpression\')"/>' +
              '</div>' +
            '</div>',
