...
var CustomMultiTreeSelect = /*#__PURE__*/function (_Component) {
  _inherits(CustomMultiTreeSelect, _Component);

  var _super = _createSuper(CustomMultiTreeSelect);

  function CustomMultiTreeSelect(props) {
    var _this;

    _classCallCheck(this, CustomMultiTreeSelect);
  ...
  _createClass(CustomMultiTreeSelect, [{
    ...
    value: function render() {
      ...
      var value = this.props.value; // 对于value值为空数组的情况，value的值传入undefined，这样才能显示组件的placeholder
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        labelInValue: true,
        showCheckedStrategy: selectLeafOnly ? _antd.TreeSelect.SHOW_CHILD : _antd.TreeSelect.SHOW_ALL,
        value: value,
        treeData: data,
        disabled: disabled,
        readOnly: readonly,
        ...
        onChange: function onChange(value) {
          var submitValue = value.map(function (item) {
            return item.value;
          });

          _onChange(submitValue);
        },
  ...
  return CustomMultiTreeSelect;
}(_react.Component);

exports["default"] = CustomMultiTreeSelect;

_defineProperty(CustomMultiTreeSelect, "propTypes", {
