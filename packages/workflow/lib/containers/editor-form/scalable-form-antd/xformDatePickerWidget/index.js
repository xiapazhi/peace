...
})("234b61e5e2a12ada31b92822455bd1fd", ".xform-custom-datepicker .ant-calendar-picker{width:100%!important}");

var MonthPicker = _antd.DatePicker.MonthPicker;

var CustomDatePickerWidget = /*#__PURE__*/function (_Component) {
  _inherits(CustomDatePickerWidget, _Component);
      ...
      switch (format) {
        case 'date':
          if (typeof value !== 'undefined' && value !== '') {
            form = /*#__PURE__*/_react["default"].createElement(_antd.DatePicker, _extends({}, options, {
              placeholder: placeholder,
              disabled: disabled,
              value: (0, _moment["default"])(value, 'YYYY-MM-DD'),
            ...
            form = /*#__PURE__*/_react["default"].createElement(_antd.DatePicker, _extends({}, options, {
              placeholder: placeholder,
              disabled: disabled,
              value: undefined //value={moment(moment(), 'YYYY-MM-DD')}
              ,
              getCalendarContainer: popupContainer,
              onChange: function onChange(date, dateString) {
                _onChange(dateString);
        ...
        case 'month':
          if (typeof value !== 'undefined' && value !== '') {
            form = /*#__PURE__*/_react["default"].createElement(MonthPicker, _extends({}, options, {
              placeholder: placeholder,
              disabled: disabled,
              value: (0, _moment["default"])(value, 'YYYY-MM'),
              getCalendarContainer: popupContainer,
              onChange: function onChange(date, dateString) {
                _onChange(dateString);
              }
            ...
            form = /*#__PURE__*/_react["default"].createElement(MonthPicker, _extends({}, options, {
              placeholder: placeholder,
              disabled: disabled,
              value: undefined //value={moment(moment(), 'YYYY-MM')}
              ,
              getCalendarContainer: popupContainer,
              onChange: function onChange(date, dateString) {
                _onChange(dateString);
...
_defineProperty(CustomDatePickerWidget, "propTypes", {
  schema: _propTypes["default"].shape({
    format: _propTypes["default"].oneOf(['date', 'month'])
  })
});