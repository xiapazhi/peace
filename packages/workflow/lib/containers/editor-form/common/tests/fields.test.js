...
var originJsonForm = {
  ...
  "sequence": ["buId", "bizType", "touchId", "caseStatus", "departmentId", "memberName", "channelType", "id", "memberType", "channelId", "memberId", "srType", "sopCateId", "fromInfo", "planFinishTime", "questionId", "ownerName", "refCaseId", "dataType", "bizId", "questionInfo", "iPiCMSEdFF", "Na2rFxhraP", "HEafxt2p6p", "E7NAfemFpW", "zrc4nM3SGm", "xaktfGDb62", "scPxrX3Ynr", "PxSHBtRjNJ", "tYdZERt5Af", "ANSF7aC87E", "bpFKS3Yaxy", "DWdFzYtK3E", "r8eG4zjrZ4", "M7ttsKkbPM", "rAM6XDWiSD", "JTjrTxG3Ew", "TipiWdkZwb", "BMsGhWMe2Z", "G6smPAtzEs", "rjxcsBPiDM", "NmWSzjZTdt", "NHQmmGRRWS", "hsKpcKRHtp", "Ch7czSeRnS"],
  "extension": {
    "bizCode": "case"
  }
};
...
test('isSchemaLegal', function () {
  expect((0, _fields.isSchemaLegal)(originJsonForm)).toBe(true);
});
test('getFieldsBySchema', function () {
  var resultFields = (0, _fields.getFieldsBySchema)(originJsonForm);
