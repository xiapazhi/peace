...
import CustomButton from './xformButtonWidget';
...
import CustomObjectFieldTemplate from './templates/customObjectFieldTeplate';
import CustomCalculate from './xformCalculateWidget';
import CustomLink from './xformLinkWidget';

import Logger from './logger';

import CustomAmapInput from './xformAmapInputWidget'//高德地图组件
import CustomTransferWidget from './xformTransferWidget'//穿梭框组件
import CustomStampInput from './xformStampInputWidget'//选择印章组件
import CustomTableSelect from './xformTableSelectWidget'//表格数据选择组件
import CustomTable from './xformTableWidget'//表格控件
...
const customWidgets = {
    ...
    amapInput: CustomAmapInput,
    button: CustomButton,
    Transfer: CustomTransferWidget,
    Stamp: CustomStampInput,
    TableSelect: CustomTableSelect,
    Table: CustomTable,
...
class XForm extends Component {
    ...
    render() {
        const { env, messages, formContext, registerWidgets, registerFields, registerFieldTemplate, registerArrayFieldTemplate, registerObjectFieldTemplate, formItemLayout, bizCode, customGateway, customInterfaces, mockInterfaces, customInterfacesParams, customUploadRequest, alignType, labelType, labelAlign, itemNumberInRow, className, validation, onImagePreview, noLabel, defaultSubmitButton, isFieldList } = this.props;
        ...
        return (
            <XFormCore
                ...
                className={classnames({
                    ...
                    'xform-action-hidden': /* !defaultSubmitButton */true,
