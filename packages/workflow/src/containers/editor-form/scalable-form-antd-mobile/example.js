        ...
        return (
            <div>
                ...
                <XFormMobile
                    ...
                    // }}
                    customUploadRequest={(file, action, uploadType, getUrl, onErr) => {
                        ///附件上传
                        ...
                        if (action == 'upload') {
                            ...
                            RouteRequest.post(RouteTable.fileUpload, formData, {
                                type: type,
                            }).then(
                                (res) => {
                                    if (res && res.filename) {
                            ...
                            //删除附件
                            RouteRequest.delete(RouteTable.cleanUpUploadTrash, {
                                url: file.response
                            });
                        }
                    }}
